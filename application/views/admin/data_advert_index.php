...
<div class="container">
	...
	<fieldset class="s_container">
		<legend>广告选择</legend>
		<ul class="cols-3">
			<li style="line-height: 35px;"><strong>广告选择：</strong>
				<select id="adid"><?php foreach ($adverts as $ad) { ?> 
					<option value="<?php echo $ad['id']; ?>"><?php echo $ad['advertise_name']; ?></option>
				<?php } ?></select></li>
	...
	<fieldset>
		...
		<div style="margin: 10px auto; position: relative;"><div id="graphdiv" style="margin: 0 auto;width: 100%; "> 
			<p>请选择广告和时间段查询...</p> </div></div>
	</fieldset>
</div>

</body>
<script type="text/javascript">
	var ask_url = "<?php echo site_url('admin/data_advert/ask') ;?>";
	var _id = "<?php echo $id; ?>";	
	...
	$("#do_search").click( function() {
		var adid 	= $("#adid option:selected").val();
		...
		$.getJSON(ask_url, { 'id' : adid, 't1' : start_date, 't2' : end_date}, function(jsondata) {
